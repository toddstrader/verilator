...
const VerilatedIfaceRef* VerilatedContext::ifaceRefFind(const char* namep) const VL_MT_SAFE {
...
const VerilatedIfaceRefMap* VerilatedContext::ifaceRefMap() VL_MT_SAFE {
    return &(impp()->m_impdatap->m_ifaceRefMap);
}
...
void VerilatedIfaceRef::ifaceRefDump() const VL_MT_SAFE {
