...
public:
    ...
    const VerilatedIfaceRef* ifaceRefFind(const char* namep) const VL_MT_SAFE;
    const VerilatedIfaceRefMap* ifaceRefMap() VL_MT_SAFE;
...
public:
    ...
    void ifaceRefDump() const VL_MT_SAFE;
};
